...
export default {
  ...
  bn: {
    ...
    Laboratorist:'ল্যাবোরাটরিস্ট',
    Accountant:'হিসার রক্ষক',
    Receptionist:'রিসেপসনিস্ট',
    Doctor:'ডাক্তার',
    Patient:'রোগী',
    Room:'রুম ',
    Bed:'বিছানা',
    Appointment:'দেখা করা',
    TreatmentHistory:'চিকিৎসা হিস্টরি',
    MainDepartment: 'মূল বিভাগ',
    ExpenseCategory: 'ব্যয় ক্যটেগরি',
    MedicineCategory: 'ঔষধ ক্যটেগরি',
    eCommerce: 'eCommerce',
    Project:'Project',
    Apps: 'Apps',
    Todo: 'Todo',
