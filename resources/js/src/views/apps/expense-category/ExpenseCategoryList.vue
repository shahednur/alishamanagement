<!-- =========================================================================================
  File Name: ExpenseCategoryList.vue
                        ...
                        <vs-tr v-for="(category, index) in excategories" :key="index">
                            ...
                            <vs-td nowrap>
                                <div class="flex">
                                    ...
                                    <div class="flex items-center">
                                        <vs-button color="danger" type="flat" icon-pack="feather" icon="icon-delete" @click="deleteRecord(category.id);confirmDeleteRecord(category.category);"></vs-button>
                                    </div>
                                </div>
                            </vs-td>
                        </vs-tr>
