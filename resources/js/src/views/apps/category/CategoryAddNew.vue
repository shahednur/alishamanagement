<!-- =========================================================================================
  File Name: CategoryAddNew.vue
  Description: Category module add new
  ----------------------------------------------------------------------------------------
            ...
            <form  @submit.prevent="editModal ? updateCategory() : createCategory()">
              <div class="vx-row">
                        <div class="vx-col w-full">
                            <vs-input class="w-full" name="name" label="Category Name" v-model="form.name" placeholder="Category Name" />
